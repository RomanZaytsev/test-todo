...
> **TODO-PHP** - это современное веб-приложение для управления задачами (ToDo list), разработанное с использованием чистого PHP без сторонних фреймворков. Приложение реализует архитектуру MVC и предоставляет удобный интерфейс для создания, просмотра и управления задачами.
...
- **PDO/MySQLi** - работа с базой данных
...
```
todo-php/
├── 📂 configs/                # Конфигурация базы данных
...
2. Добавьте модель в `models/` (при необходимости)
...
- [x] **Защита от SQL-инъекций**: через `real_escape_string`
